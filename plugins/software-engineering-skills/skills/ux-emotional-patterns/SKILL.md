---
name: ux-emotional-patterns
description: Emotional design and delight patterns — Walter's hierarchy of user needs, empty states, first-run onboarding, UI tone of voice, microinteractions, and a journey-phase-to-target-emotion table. Load when designing onboarding, empty or error states, or when mapping how a journey should feel at each step.
