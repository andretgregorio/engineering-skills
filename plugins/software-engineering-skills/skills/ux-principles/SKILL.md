---
name: ux-principles
description: Core UX principles — Nielsen's heuristics, Norman's principles, Fitts/Hick/Miller, progressive disclosure, WCAG 2.2 AA minimums, and a review checklist. Load whenever a feature under refinement touches a user-facing surface: to evaluate a design, write UX acceptance criteria, or review a wireframe or mockup.
