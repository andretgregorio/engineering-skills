...
description: Terminal UI and CLI design patterns — argument and subcommand design, interactive TUI architectures, colour and output contracts, error and help text, progress and responsiveness, anti-patterns, and a review checklist. Load when the surface under refinement is a command-line tool or an interactive terminal application.
