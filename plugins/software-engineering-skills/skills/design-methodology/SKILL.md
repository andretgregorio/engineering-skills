...
description: Apple LeanUX++ design workflow — journey mapping, emotional arc design, progressive-fidelity prototyping, and integration checks. Load from /product-analysis when mapping a user journey and how it should feel (Phases 1–2), and from /specs when prototyping a surface at low fidelity and checking that its steps connect (Phases 3–4).
