...
description: User story mapping for backlog management and outcome-based prioritization.
user-invocable: true
...
### Create a team of agents. The team should be composed by:
- Product Owner subagent.
- Lead Product Designer subagent.
- Acceptance Designer subagent.
