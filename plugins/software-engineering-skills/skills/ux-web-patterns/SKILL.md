...
description: Web UI design patterns — navigation, forms and validation, data display, responsive breakpoints, component and motion patterns, design tokens, and anti-patterns. Load when the surface under refinement is a browser-based application.
